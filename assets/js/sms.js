...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detail = __webpack_require__(418);

	var _detail2 = _interopRequireDefault(_detail);

	var _column = __webpack_require__(420);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detail = __webpack_require__(419);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _column = __webpack_require__(421);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MODIFY_COLUMN = undefined;
	...
	var MODIFY_COLUMN = exports.MODIFY_COLUMN = 'modify_column';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modal = __webpack_require__(423);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var columnAction = _interopRequireWildcard(_column);
	...
	var App = function (_Component) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'container sms' }, _react2.default.createElement(_head2.default, null), _react2.default.createElement(_container2.default, { group: group, detail: detail, column: column, actions: actions, modal: modal }), _react2.default.createElement(_foot2.default, null));
	        }
	    }]);
	    return App;
	}(_react.Component);
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)((0, _assign2.default)({}, groupAction, detailAction, columnAction, modalAction), dispatch)
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leftWrap = __webpack_require__(426);

	var _leftWrap2 = _interopRequireDefault(_leftWrap);

	var _rightWrap = __webpack_require__(429);
	...
	var Container = function (_Component) {
	    ...
	    (0, _createClass3.default)(Container, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'flyme-content clearfix', id: 'flymeContent' }, _react2.default.createElement('div', { className: 'flyme-content-body' }, _react2.default.createElement(_index2.default, { type: 'sms' }), _react2.default.createElement(_leftWrap2.default, { column: column, group: group, actions: actions }), _react2.default.createElement(_rightWrap2.default, { detail: detail, group: group, modal: modal, actions: actions })));
	        }
	    }]);
	    return Container;
	}(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _columnLi = __webpack_require__(427);

	var _columnLi2 = _interopRequireDefault(_columnLi);

	var _smsLi = __webpack_require__(428);
	...
	var LeftWrap = function (_Component) {
	    ...
	    function LeftWrap(props) {
	        ...
	        _this.changeColumn = function (index) {
	            if (index == _this.props.column) {
	                return false;
	            }
	            _this.props.actions.resetFirstFetch();
	            _this.props.actions.resetDetailFirstFetch();
	            _this.props.actions.modifyColumn(index);
	            setTimeout(function () {
	                _this.props.actions.queryGroup();
	                _this.props.actions.changeDataType('origin');
	            }, 0);
	        };
	    ...
	    (0, _createClass3.default)(LeftWrap, [{
	        ...
	        value: function render() {
	            ...
	            var cLi = clist.map(function (value, index) {
	                var active = false;
	                if (value.index === column) {
	                    active = true;
	                }
	                return _react2.default.createElement(_columnLi2.default, { active: active, name: value.name, key: index, index: value.index, actions: actions, changeColumn: _this2.changeColumn });
	            });
	            ...
	            return _react2.default.createElement('div', { className: 'left-wrap', id: 'leftWrap' }, _react2.default.createElement('div', { className: 'left-header' }, _react2.default.createElement('ul', { className: 'left-head-list clearfix' }, cLi)), _react2.default.createElement('div', { className: leftBodyClass, ref: 'ul' }, groupDom), choseAllDom);
	        }
	    }]);
	    return LeftWrap;
	}(_react.Component);
	...
	var LeftWrap = function (_Component) {
	    ...
	    function LeftWrap(props) {
	        ...
	        _this.handleClick = function () {
	            _this.props.changeColumn(_this.props.index);
	        };
	    ...
	    (0, _createClass3.default)(LeftWrap, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('li', null, _react2.default.createElement('a', { href: 'javascript:void(0);', className: this.props.active ? 'active' : '', onClick: this.handleClick }, this.props.name));
	        }
	    }]);
	    return LeftWrap;
	}(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detailList = __webpack_require__(430);

	var _detailList2 = _interopRequireDefault(_detailList);

	var _multiList = __webpack_require__(432);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detailLi = __webpack_require__(431);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _multiLi = __webpack_require__(433);
